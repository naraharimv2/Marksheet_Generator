...
public class Home extends JFrame implements ActionListener {
    ...
    Home() {
        ...
        heading = new JLabel("MARKSHEET GENERATOR");
        heading.setBounds(550, 0, 400, 150);
        con.add(heading);
        ...
        welcome.setBounds(580, 30, 400, 150);
        con.add(welcome);
        ...
        insert = new JButton("Insert/Update Details");
        insert.addActionListener(this);
        insert.setBounds(500, 275, 175, 50);
        ...
        delete.setBounds(800, 275, 175, 50);
        ...
        display.setBounds(500, 425, 175, 50);
        ...
        search.setBounds(800, 425, 175, 50);
        ...
        eligible = new JButton("Generate Marksheet");
        eligible.addActionListener(this);
        eligible.setBounds(500, 575, 495, 50);
